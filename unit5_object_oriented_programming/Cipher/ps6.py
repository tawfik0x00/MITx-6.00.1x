...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(26):
            ...
            string.ascii_lowercase[shift_index]
            
            shift_dict[string.ascii_uppercase[i]] = \
            string.ascii_uppercase[shift_index]
    ...
    def apply_shift(self, shift):
        ...
        for letter in self.message_text:
            output += shifted_letters.get(letter,letter)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            # Apply the shift to decrypt the message
            decrypted_text = self.apply_shift(shift)
            
            # Split the decrytped text into words
            words = decrypted_text.split(' ')
            
            # count how many valid words there are
